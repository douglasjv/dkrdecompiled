...
void trackbg_render_flashy(void) {
    ...
    zPositions[0] = -(xCos * 1280.0f) + (xSin * 1280.0f);
    xPositions[1] = (xCos * 1280.0f) - (xSin * 1280.0f);
    zPositions[1] = -(xCos * 1280.0f) - (xSin * 1280.0f);
    xPositions[2] = (xCos * 1280.0f) + (xSin * 1280.0f);
    zPositions[2] = (xCos * 1280.0f) - (xSin * 1280.0f);
    xPositions[3] = -(xCos * 1280.0f) + (xSin * 1280.0f);
    zPositions[3] = (xCos * 1280.0f) + scaledXSin;
    xPositions[4] = 0.0f;
    zPositions[4] = 0.0f;
