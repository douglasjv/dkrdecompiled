...
void func_80049794(s32 updateRate, f32 updateRateF, Object *obj, Object_Racer *racer)
{
  ...
  {
    sound_play(SOUND_ZAP4, 0);
    racer->spinout_timer = 20;
  }
  spA2 = 0;
  if (((gCurrentPlayerIndex != PLAYER_COMPUTER) && (racer->vehicleIDPrev != VEHICLE_WIZPIG)) && (gRacerWaveCount != 0))
  {
    for (var_a0 = gRacerWaveCount - 1; (var_a0 >= 0) && (gRacerCurrentWave[var_a0]->waveHeight < (obj->trans.y_position + 5)); var_a0--)
    {
    }
  ...
  var_f20 = sqrtf(((obj->x_velocity * obj->x_velocity) + (obj->z_velocity * obj->z_velocity)) + (obj->y_velocity * obj->y_velocity)) - 2.0;
  ...
  if (racer->groundedWheels != 0)
  {
    ...
    if (((racer->playerIndex == PLAYER_ONE) && (i == SURFACE_TAJ_PAD)) && (gCurrentButtonsPressed & 0x2000))
    {
      gTajInteractStatus = TAJ_TELEPORT;
    }
  ...
  if ((racer->zipperDirCorrection != 0) && (racer->spinout_timer == 0))
  {
    ...
    if (((steerVisualRotationOffset < 0x400) && (steerVisualRotationOffset > (-0x400))) || (racer->playerIndex == PLAYER_COMPUTER))
    {
      if (racer->playerIndex != PLAYER_COMPUTER)
      {
        sound_play_spatial(SOUND_ZIP_PAD_BOOST, obj->trans.x_position, obj->trans.y_position, obj->trans.z_position, 0);
        play_random_character_voice(obj, SOUND_VOICE_KRUNCH_POSITIVE1, 8, 0x80 | 0x2);
      }
      racer->boostTimer = normalise_time(45);
      racer->boostType = BOOST_LARGE;
  ...
  if (racer->spinout_timer != 0)
  {
    ...
    if ((racer->groundedWheels != 0) && ((((xRotationOffset > 0x6000) && (racer->x_rotation_offset <= 0x6000)) || ((xRotationOffset > (-0x6000)) && (racer->x_rotation_offset <= (-0x6000)))) || ((xRotationOffset > 0) && (racer->x_rotation_offset <= 0))))
    {
    ...
    gCurrentRacerInput &= ~(0x8000 | 0x2000);
    ...
    if ((racer->trickType == 2) || (racer->trickType == (-2)))
  {
    ...
    if (racer->unk1D5 == 0)
    {
      obj->trans.rotation.x_rotation = var_v1 + ((racer->trickType * (((0x180 & 0xFFFFFFFF) & 0xFFFFFFFF) & 0xFFFFFFFF)) * updateRate);
    }
    ...
    if (racer->trickType == 2)
    {
      ...
      if (((var_t0 > 0x4000) && (obj->trans.rotation.x_rotation < (-0x4000))) && (gCurrentRacerInput & 0x0010))
      {
        racer->unk1D5 = 60;
      }
    }
  ...
  else
  {
    ...
    if (racer->groundedWheels < 2)
    {
      ...
      if (racer->zipperDirCorrection == 0)
      {
        if ((gCurrentPlayerIndex != PLAYER_COMPUTER) && (racer->raceFinished == 0))
        {
          ...
          if ((gCurrentRacerInput & 0x0010) && (gCurrentRacerInput & 0x4000))
          {
            var_t0 *= 2;
          }
    ...
    if (((!(gCurrentRacerInput & 0x0010)) || (racer->groundedWheels == 0)) || (racer->zipperDirCorrection != 0))
    {
  ...
  if ((racer->zipperDirCorrection == 0) && (gRaceStartTimer == 0))
  {
    ...
    if ((spEC < 1.0f) && (!(gCurrentRacerInput & 0x8000)))
    {
  ...
  if (racer->approachTarget == 0)
  {
    ...
    if (move_object(obj, var_f20 * updateRateF, obj->y_velocity * updateRateF, spEC * updateRateF) && (gCurrentPlayerIndex != PLAYER_COMPUTER))
    {
      playerObjectMoved = 1;
    }
  }
  ...
  mtxf_transform_point((MtxF *) (&sp60), obj->x_velocity, obj->y_velocity, obj->z_velocity, &racer->lateral_velocity, &racer->unk34, &racer->velocity);
  if ((obj->attachPoints != 0) && (obj->attachPoints->count >= 3))
  {
  ...
  if (((gCurrentPlayerIndex != PLAYER_COMPUTER) && (racer->boostTimer == 0)) && (gNumViewports < 2))
  {
      ...
      if ((boostObj->unk70 == 2) && (boostObj->unk74 < 0.5))
    {
      ...
      if ((boostObj->unk70 < 2) && (boostObj->unk74 > 0.0f))
    {
      obj->particleEmittersEnabled |= 1 << var_t0;
    }
  }
