...
- Generated at: 2026-05-23 08:02:43Z
- Branch: `master`
- HEAD: `9a272565`
- Completed task: `func_80049794`
- Summary: Rejected current-baseline low-speed drag multiply grouping spelling: changed racer->velocity * spD8 * 8.0f to racer->velocity * (spD8 * 8.0f). Full verify failed with calculated CRCs 0x5FD5CB40/0x334EF099, and relinked focused diff stayed CURRENT (2760): no target $f20/$f21 saves, early zero stayed $f16 instead of target $f14, wave scan stayed current a0-bound/v1-loop, and only constants/later call targets shifted in the promoted current-baseline family. Source was restored.
