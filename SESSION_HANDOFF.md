...
- Generated at: 2026-05-14 22:58:50Z
- Branch: `master`
- HEAD: `d218273c`
- Completed task: `DKR-MATCH-FUNC-80059208-DATAFLOW-PROBE`
- Summary: No new source match landed. This pass rejected one additional ordinary-C `func_80059208` final-offset dataflow probe while keeping the function active.
...
- `gmake build/src/racer.c.o CROSS=tools/binutils/mips64-elf-` -> promoted `func_80059208` probe compiles
- `./diff.sh -o func_80049794 -s --compress-matching 3 --no-pager` -> baseline promoted source still scores `CURRENT (2550)`, nonmatching
- `./diff.sh -o func_80059208 -s --compress-matching 3 --no-pager` -> baseline promoted source scores `CURRENT (870)`; rejected target-dataflow order worsened to `CURRENT (1684)`, nonmatching
