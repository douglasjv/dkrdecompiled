...
- Generated at: 2026-05-23 08:13:08Z
- Branch: `master`
- HEAD: `debaf949`
- Completed task: `func_80049794`
- Summary: Rejected current-baseline race-start y-velocity double-literal spelling: changed obj->y_velocity = -5.0f to obj->y_velocity = -5.0 in the gRaceStartTimer == 100 path. Full verify failed with calculated CRCs 0x5FDDE03F/0xEF7A0514, and relinked focused diff stayed CURRENT (2760): no target $f20/$f21 saves, early zero stayed $f16 instead of target $f14, wave scan stayed current a0-bound/v1-loop, and only constants/later call targets shifted in the promoted current-baseline family. Source was restored.
