...
- Generated at: 2026-05-23 03:06:18Z
- Branch: `master`
- HEAD: `a7c22819`
- Completed task: `func_80049794`
- Summary: Current-baseline adjacent `var_a0`/`var_v1` declaration-order swap missed; full verify failed with CRCs 0x5FDDE03F/0xEF7A0514 and relinked focused diff stayed CURRENT (2760). The probe produced no object movement: $f20/$f21 prologue saves were still absent, early zero stayed in $f16, and the wave bound/index allocation remained reversed as current a0/v1 instead of target v1/a0. Source was restored.
