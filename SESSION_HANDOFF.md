...
- Generated at: 2026-05-14 23:33:33Z
- Branch: `master`
- HEAD: `deafcbdb`
- Completed task: `DKR-MATCH-FUNC-80049794-SQRT-IDX-PROBES`
- Summary: No new source match landed. This pass rejected two ordinary-C `func_80049794` lifetime probes while keeping the function active.
...
- `./diff.sh -o func_80049794 -s --compress-matching 3 --no-pager` -> baseline promoted C remains `CURRENT (2550)`; the two-step first `sqrtf` subtraction and `racerMiscAssetIdx` fractional reuse probes also leave `CURRENT (2550)`, nonmatching
