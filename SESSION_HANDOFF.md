...
- Generated at: 2026-05-14 23:16:39Z
- Branch: `master`
- HEAD: `97c920d0`
- Completed task: `DKR-MATCH-FUNC-80049794-SPA3-SCHEDULE-PROBE`
- Summary: No new source match landed. This pass rejected one ordinary-C `func_80049794` scheduling probe while keeping the function active.
...
- `gmake build/src/racer.c.o CROSS=tools/binutils/mips64-elf-` -> promoted `func_80049794` and `func_80059208` C candidates compile
- `./diff.sh -o func_80049794 -s --compress-matching 3 --no-pager` -> baseline promoted C scores `CURRENT (2550)`; moving `spA3 = FALSE` after the inverse-gravity calculation leaves `CURRENT (2550)`, nonmatching
- `./diff.sh -o func_80059208 -s --compress-matching 3 --no-pager` -> baseline promoted C remains `CURRENT (870)`; no new non-duplicative final-offset source probe was applied
