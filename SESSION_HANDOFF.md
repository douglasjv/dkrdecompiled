...
- Generated at: 2026-05-23 06:31:31Z
- Branch: `master`
- HEAD: `c761f627`
- Completed task: `func_80049794`
- Summary: Rejected current-baseline first-speed boss guard operand-order spelling: if (VEHICLE_BOSSES <= racer->vehicleID). Object-only diff first showed stale CURRENT (0), full verify failed with promoted-baseline CRCs 0x5FDDE03F/0xEF7A0514, and relinked diff stayed CURRENT (2760): no target $f20/$f21 saves, GPR save slots shifted down, early zero stayed $f16, wave scan current a0-bound/v1-loop. Source was restored.
