...
- Generated at: 2026-05-23 06:42:34Z
- Branch: `master`
- HEAD: `a539b471`
- Completed task: `func_80049794`
- Summary: Rejected current-baseline exit-throttle single-precision literal spelling: racer->throttle = 0.5f. Full verify failed with promoted-baseline CRCs 0x5FDDE03F/0xEF7A0514, and relinked focused diff stayed CURRENT (2760): no target $f20/$f21 saves, GPR save slots shifted down, early zero stayed $f16, wave scan current a0-bound/v1-loop. Source was restored.
