...
- Generated at: 2026-05-23 07:41:37Z
- Branch: `master`
- HEAD: `ea12fe61`
- Completed task: `func_80049794`
- Summary: Rejected current-baseline grounded stick-scale operand-order spelling: changed gCurrentStickY scale from (1.0 - var_f20) * ((f32) gCurrentStickY) to ((f32) gCurrentStickY) * (1.0 - var_f20). Object-only focused diff first printed stale CURRENT (0). Full verify failed with calculated CRCs 0x6036E63F/0x817F988F, and relinked focused diff regressed to CURRENT (2795): no target $f20/$f21 saves, early zero stayed $f16, wave scan stayed current a0-bound/v1-loop, and later gravity stayed in the wrong $f14 family. Source was restored.
