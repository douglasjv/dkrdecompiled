...
- Generated at: 2026-05-23 08:06:59Z
- Branch: `master`
- HEAD: `8f76f0b9`
- Completed task: `func_80049794`
- Summary: Rejected current-baseline A-button throttle clamp literal spelling: changed racer->throttle = 1 to racer->throttle = 1.0f and racer->throttle < 0 to racer->throttle < 0.0f. Full verify failed with calculated CRCs 0x5FDDE03F/0xEF7A0514, and relinked focused diff stayed CURRENT (2760): no target $f20/$f21 saves, early zero stayed $f16 instead of target $f14, wave scan stayed current a0-bound/v1-loop, and only constants/later call targets shifted in the promoted current-baseline family. Source was restored.
