...
- Generated at: 2026-05-23 07:51:27Z
- Branch: `master`
- HEAD: `b3bd897a`
- Completed task: `func_80049794`
- Summary: Rejected current-baseline trick lift scale constant-grouping spelling: changed spEC scale from racer->velocity * 0.058823529411764705 * 1.5 to racer->velocity * (0.058823529411764705 * 1.5). Full verify failed with calculated CRCs 0x57E6973B/0x9F5650FC, and relinked focused diff stayed CURRENT (2760): no target $f20/$f21 saves, early zero stayed $f16, wave scan stayed current a0-bound/v1-loop, and only constants/later call targets shifted in the promoted current-baseline family. Source was restored.
