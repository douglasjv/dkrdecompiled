...
- Generated at: 2026-05-23 06:54:00Z
- Branch: `master`
- HEAD: `7482925a`
- Completed task: `func_80049794`
- Summary: Rejected current-baseline throttle-rate single-precision literal spelling: changed both throttle rate updates to updateRateF * 0.01f. Full verify failed with calculated CRCs 0xE2FEB7C7/0xB4368A76, and relinked focused diff regressed to CURRENT (6518): no target $f20/$f21 saves, early zero stayed $f16, wave scan current a0-bound/v1-loop, later gravity/call-adjacent/sound scheduling drift widened. Source was restored.
