...
- Generated at: 2026-05-23 07:59:05Z
- Branch: `master`
- HEAD: `6f43304f`
- Completed task: `func_80049794`
- Summary: Rejected current-baseline low-speed drag condition-order spelling: changed the drag branch condition from spEC < 1.0f && !(gCurrentRacerInput & A_BUTTON) to !(gCurrentRacerInput & A_BUTTON) && spEC < 1.0f. Full verify failed with calculated CRCs 0x5FDDE03B/0xCF4A45EB, and relinked focused diff stayed CURRENT (2760): no target $f20/$f21 saves, early zero stayed $f16, wave scan stayed current a0-bound/v1-loop, and only constants/later call targets shifted in the promoted current-baseline family. Source was restored.
