...
- Generated at: 2026-05-23 07:48:54Z
- Branch: `master`
- HEAD: `22ad7bcd`
- Completed task: `func_80049794`
- Summary: Rejected current-baseline brake negative-velocity double-zero spelling: changed the B-button brake condition from racer->velocity < 0.0f to racer->velocity < 0.0. Full verify failed with calculated CRCs 0x334AD7AC/0x83F55E31, and relinked focused diff regressed to CURRENT (5125): no target $f20/$f21 saves, early zero stayed $f16, wave scan stayed current a0-bound/v1-loop, and the later brake/gravity path gained broad double-conversion scheduling. Source was restored.
