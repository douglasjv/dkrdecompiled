...
- Generated at: 2026-05-23 07:56:27Z
- Branch: `master`
- HEAD: `6bde1642`
- Completed task: `func_80049794`
- Summary: Rejected current-baseline vertical drag scale grouping spelling: changed vertical drag addend from 4.0f * (racer->unk34 * spD0) to racer->unk34 * (spD0 * 4.0f). Full verify failed with calculated CRCs 0x5FF4CBE3/0xAB5E4543, and relinked focused diff stayed CURRENT (2760): no target $f20/$f21 saves, early zero stayed $f16, wave scan stayed current a0-bound/v1-loop, and only constants/later call targets shifted in the promoted current-baseline family. Source was restored.
