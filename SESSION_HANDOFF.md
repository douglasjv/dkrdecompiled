...
- Generated at: 2026-05-23 04:53:44Z
- Branch: `master`
- HEAD: `e12aea10`
- Completed task: `func_80049794`
- Summary: Current-baseline course-height guard operand-order probe (`0.0f > var_f2`) missed; object-only focused diff first printed stale `CURRENT (0)`, full verify failed with calculated CRCs `0xA7DACB8B/0x793F4084`, and relinked focused diff regressed to `CURRENT (3575)`. The probe did not recover target `$f20/$f21` prologue saves, kept early zero in `$f16` instead of `$f14`, and left the wave loop reversed as current `a0`-bound/`v1`-loop instead of target `v1`-bound/`a0`-loop. Source was restored.
