...
- Generated at: 2026-05-14 23:22:42Z
- Branch: `master`
- HEAD: `6f673b82`
- Completed task: `DKR-MATCH-FUNC-80059208-FINAL-OFFSET-PROBES`
- Summary: No new source match landed. This pass rejected two ordinary-C `func_80059208` final-offset probes while keeping the function active.
...
- `./diff.sh -o func_80059208 -s --compress-matching 3 --no-pager` -> baseline promoted C remains `CURRENT (870)`; inlining only `obj->trans.x_position` worsens to `CURRENT (1826)`; routing the checkpoint dot through `pad3` leaves `CURRENT (870)`, nonmatching
