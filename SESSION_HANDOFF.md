...
- Generated at: 2026-05-23 07:46:10Z
- Branch: `master`
- HEAD: `d6dca0bc`
- Completed task: `func_80049794`
- Summary: Rejected current-baseline forwardVel damping sum-order spelling: changed damping sum from racer->forwardVel + (racer->velocity * 0.05) to (racer->velocity * 0.05) + racer->forwardVel. Object-only focused diff first printed stale CURRENT (0). Full verify failed with calculated CRCs 0x5FDD003F/0x3118A39C, and relinked focused diff stayed CURRENT (2760): no target $f20/$f21 saves, early zero stayed $f16, wave scan stayed current a0-bound/v1-loop, and later gravity stayed in the wrong $f14 family. Source was restored.
