...
- Generated at: 2026-05-23T04:48:07Z
- Branch: `master`
- HEAD: `b4e65f3a`
- Completed task: `func_80049794`
- Summary: Close save-family x/z/y pre-sqrt branch with chained grounded-wheel zero, steer-vel no-op, removed trailing pad3/pad4, and first-speed zero-threshold upper clamp (`if (var_f20 > 0.0) { var_f20 = 4; }`) missed; object-only focused diff first printed stale CURRENT (0), full verify failed with calculated CRCs 0xF07192B5/0xD69ABBCC, and relinked focused diff regressed to CURRENT (5315). The probe kept target frame/$f20/$f21 saves and early $f14 zero, but left the wave loop reversed as current a0-bound/v1-loop instead of target v1-bound/a0-loop and disturbed later call/sound scheduling. Source was restored.
