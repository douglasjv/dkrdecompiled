...
- Generated at: 2026-05-14 23:39:28Z
- Branch: `master`
- HEAD: `dc17faec`
- Completed task: `DKR-MATCH-FUNC-80049794-FLOAT-CONSTANT-PROBE`
- Summary: No new source match landed. This pass rejected one ordinary-C `func_80049794` velocity-clamp constant probe while keeping the function active.
...
- `./diff.sh -o func_80049794 -s --compress-matching 3 --no-pager` -> baseline promoted C remains `CURRENT (2550)`; making the velocity clamp constants explicitly single-precision (`4.0f`/`3.0f`) worsens to `CURRENT (3045)`, nonmatching
