...
- Latest validation baseline: `python3 tools/check_active_surface.py`, `python3 tools/query_goal_state.py next --compact --refresh`, `python3 tools/query_goal_state.py tooling`, `python3 tools/query_goal_state.py revival`, `python3 tools/query_goal_state.py packet --function func_8008FF1C`, `python3 -m py_compile tools/query_goal_state.py`, `gmake -j4 CROSS=tools/binutils/mips64-elf-`, and `./score.sh -s` passed on 2026-05-31 after the `func_8008FF1C` pointer-to-selected-track-cell packet was rejected and cleared. Matching build reached `Verify: OK`; score remained 97.30%.
